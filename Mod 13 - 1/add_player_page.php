...
<?php
    ...
    logActivity($_SESSION['username'],"Load Add Player Page", "Add Player Page Loaded");
    //vars
    $state = "";
    ...
    if(isset($_GET['state'])){
        if($_GET['state'] === "added"){
            logActivity($_SESSION['username'],"Add Player", "Player Added");    
            $state = "Player Added";
        }
        else if($_GET['state'] === "failed"){
            logActivity($_SESSION['username'],"Add Player", "Player Add Failed");
